...
namespace SuperDeviceFactory.CHDDoorAPI
{
   ...
   public static class CHD200H　
   {
       ...
       **************************************************************/
       ...
       public static extern int FrReadVersion(uint nPortIndex, uint nNetID, StringBuilder szVersion);
       ...
       public static extern int FrAddOneUserEx(uint nPortIndex, uint nNetID, StringBuilder szUserID, StringBuilder szCardNo, StringBuilder szUserName, StringBuilder szUserNo, StringBuilder szUserPwd, int nFingerIndex1, int nFingerIndex2, int nFingerIndex3);
       ...
       public static extern int FrReadUserInfoByUserIDEx(uint nPortIndex, uint nNetID, StringBuilder szUserID, StringBuilder szCardNo, StringBuilder szUserPwd, out int pnFingerIndex1, out int pnFingerIndex2, out int pnFingerIndex3);
       ...
       public static extern int FrReadUserNum(uint nPortIndex, uint nNetID, out int pnUserCnt, out int pnFingerCnt);
       ...
       public static extern int FrRegGetState(uint nPortIndex, uint nNetID, ref uint pnState, ref uint pnFingerSize);
       ...
       public static extern int FrGetFingerData1(uint nPortIndex, uint nNetID, uint nGetIndex, ref uint pnGetSize, Byte[] lpData);
